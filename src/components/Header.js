...
function Header() {
  ...
  return (
    <div className="">
      <div
        className={`bg-white w-full fixed left-0 z-40 top-0 -translate-y-28 
        ${
          scrollY >= 250
            ? "transition-all duration-300 top-0 translate-y-0"
            : "transition-all duration-300 -translate-y-28"
        }`}
      >
        <Chilheader />
        <ChildSmHeader />
              ...
              <div className="">
                <div className="flex items-center space-x-4 xl:space-x-3 2xl:space-x-4">
                  ...
                  <button className=" relative">
                    ...
                    <p className="bg-[#FD4B6B] absolute -top-3 -right-2.5 rounded-full text-white font-semibold text-xs flex justify-center items-center w-6 h-6 tracking-wider">
                      0
                    </p>
                  </button>
                  <button className="relative">
                    <SlHandbag className="text-[25px]" />
                    <p className="bg-[#FD4B6B] absolute -top-3 -right-2.5 rounded-full text-white font-semibold text-xs flex justify-center items-center w-6 h-6">
                      9+
                    </p>
                  </button>
                </div>
            ...
            <div className="h-full flex items-center">
              <div className="relative h-full 2xl:w-[306px] xl:w-[261px] w-[230px]">
                <div
                  ...
                  className="select-none h-full 2xl:w-[306px] xl:w-[261px] w-[230px] bg-[#0989FF] hover:bg-[#010F1C] transition-all duration-500 px-7 cursor-pointer flex justify-between items-center"
                >

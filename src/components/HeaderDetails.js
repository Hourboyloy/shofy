...
function HeaderDetails() {
  ...
  return (
    <div>
      <div
        className={`bg-white w-full fixed left-0 z-30 top-0 -translate-y-28 
        ${
          scrollY >= 250
            ...
            <div className="flex items-center lg:space-x-8 space-x-14">
              <div className="hidden md:block">
                <button className=" relative 2xl:w-[363px] xl:w-[295px] lg:w-[310px] w-[240px]">
                  <input
                    className="bg-[#F8F8F8] border transition-all duration-300 focus:border-[#0989FF] border-gray-300 text-xs outline-none py-3.5 pl-6 pr-12 w-full"
                ...
                <div>
                  <div className="space-x-4 hidden lg:flex items-center">
                    ...
                    <button className=" relative">
                      ...
                      <p
                        className="bg-[#0989FF] absolute -top-3 -right-2.5 rounded-full text-white font-semibold text-xs flex justify-center items-center w-[22px]
                         h-[22px] tracking-wider"
                      >
                        0
                      </p>
                    </button>
        ...
        <div className="max-w-[1320px] mx-auto flex items-center justify-between 2xl:px-2 xl:px-20 lg:px-10 md:px-9">
          <div className="flex items-center justify-center space-x-5">
            <div className="flex items-center space-x-1">
              ...
              <p className="text-sm text-gray-600">7500k Followers</p>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <p className="text-sm text-gray-600">+(402) 763 282 46</p>
            </div>
          </div>

          <div className="flex items-center justify-center space-x-4">
            <div className="flex items-center space-x-1">
              <p className="text-sm text-gray-700 font-semibold">English</p>
